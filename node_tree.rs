...
// RC shared multiple Ownership via ref counting: Each owner of node has a RC clone.
// RC's container(smart ptr) alloc Node<T>, Each container of Node is a RC clone.
// Rc disallow mut. Container dynamic enforce borrow rules. RefCell interior mutable container.
